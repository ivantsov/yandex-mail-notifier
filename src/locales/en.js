module.exports = {
  ...
  popup: {
    ...
    unavailable: {
      ...
      subTitle:
        'There are a few possible reasons why the extension may not work properly:',
      notAuth: {
        label: 'You are not authorized.',
        checkAuth:
          "Check that you're authorized on Yandex (exactly <strong>.$1</strong> domain). Also you can choose another domain in the extension settings.",
      ...
      nothingHelped:
        'If nothing above helped, you can try to reload the extension.',
      reloadBtn: 'Reload extension',
    },
    donation: {
      text:
        'Want more settings, new features and just stable work of the extension?',
  ...
  settings: {
    newMessageNotification: {
      ...
      options: ['off', 'desktop notification', 'desktop & sound notification'],
    },
    unreadMessagesNotification: {
      label: 'Remind about unread emails via desktop notification',
      options: ['off', 'every 5 min', 'every 15 min', 'every 30 min'],
    },
    unreadMessagesSound: {
    ...
    preferredDomain: {
      ...
      options: ['ru', 'ua', 'by', 'kz', 'com', 'com.tr'],
    },
  },
};
