module.exports = {
  ...
  popup: {
    ...
    unavailable: {
      ...
      subTitle:
        'Возможны следующие причины почему расширение может работать не корректно:',
      notAuth: {
        label: 'Вы не авторизованы.',
        checkAuth:
          'Проверьте, что вы авторизованы в Яндекс (именно <strong>.$1</strong> домен). Также вы можете выбрать другой домен в настройках расширения.',
      ...
      nothingHelped:
        'Если ничего из вышеперечисленного не помогло, попробуйте перезагрузить расширение.',
      reloadBtn: 'Перезагрузить расширение',
    },
    donation: {
      text:
        'Хотите новых настроек, функций и просто стабильной работы расширения?',
  ...
  settings: {
    newMessageNotification: {
      ...
      options: ['отключено', 'только текстовое', 'текстовое и звуковое'],
    },
    unreadMessagesNotification: {
      label: 'Показывать текстовое уведомление при наличие непрочитанных писем',
      options: ['отключено', 'каждые 5 мин', 'каждые 15 мин', 'каждые 30 мин'],
    },
    unreadMessagesSound: {
