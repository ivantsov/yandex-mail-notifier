...
const Header = ({
  ...
  <div className={styles.component}>
    <Button type="primary" onClick={() => openLink('#compose')}>
    ...
    <div className={styles.centerBlock}>
      <a onClick={() => openLink()}>
        {/* we need callback here, otherwise event will be passed as a first param */}
        {user} (<strong>{unreadMessagesCount}</strong>)
      </a>
      <Button type="icon" disabled={disabled} onClick={reloadMessages}>
        <ReloadIcon className={styles.reloadIcon} />
      </Button>
    </div>
    <Button type="icon" onClick={openSettings}>
